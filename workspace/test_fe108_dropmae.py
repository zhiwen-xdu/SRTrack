...
def genConfig(seq_path, set_type):
    ...
    return rgb_img_list, event_img_list, gt
...
def run_sequence(seq_name, seq_home, dataset_name, yaml_name, num_gpu=1, epoch=60, experiment_id="01", script_name='prompt'):
    ...
    rgb_img_list, event_img_list, gt = genConfig(seq_path, dataset_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', type=str, default='FE108', help='Name of dataset (VisEvent).')
    parser.add_argument('--threads', default=28, type=int, help='Number of threads')
    parser.add_argument('--num_gpus', default=8, type=int, help='Number of gpus')
    parser.add_argument('--experiment_id', default="SIAM201", type=str, help='epochs of ckpt')
    ...
    # path initialization
    seq_list = None
    if dataset_name == 'FE108':
        seq_home = '/home/czwos/Data/FE108'
        with open('/home/czwos/Project/SIAMTrack/lib/train/data_specs/fe108_val_split.txt', 'r') as f:
