...
def main():
    ...
    parser.add_argument('--script', type=str, default='vipt', help='Name of the train script.')
    parser.add_argument('--config', type=str, default='deep_rgbe', help="Name of the config file.")
    parser.add_argument('--cudnn_benchmark', type=bool, default=True, help='Set cudnn benchmark on (1) or off (0) (default is on).')
    parser.add_argument('--local_rank', default=-1, type=int, help='node rank for distributed training')
    parser.add_argument('--save_dir', type=str, default='./output/train', help='the directory to save checkpoints and logs')  # ./output
    parser.add_argument('--seed', type=int, default=2023, help='seed for random numbers')
