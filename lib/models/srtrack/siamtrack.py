...
from lib.models.vipt.vit_siam import vit_base_patch16_224_siam
...
class SIAMTrack(nn.Module):
    ...
    #             return_last_attn=False,
    #             ):
    #     # template：[32,6,128,128]，search：[32,6,256,256]
...
def build_siamtrack(cfg, training=True):
    ...
    if cfg.MODEL.BACKBONE.TYPE == 'vit_base_patch16_224_prompt':
        backbone = vit_base_patch16_224_siam(pretrained, drop_path_rate=cfg.TRAIN.DROP_PATH_RATE,
