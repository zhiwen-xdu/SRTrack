...
from lib.models.vipt.vit_siam_lora import vit_base_patch16_224_siam_lora
...
def build_siamtrack_lora(cfg, training=True):
    ...
    if cfg.MODEL.BACKBONE.TYPE == 'vit_base_patch16_224_prompt':
        backbone = vit_base_patch16_224_siam_lora(pretrained, drop_path_rate=cfg.TRAIN.DROP_PATH_RATE,
