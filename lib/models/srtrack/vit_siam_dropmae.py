...
class VisionTransformerSiam_DropMAE(BaseBackbone):
    """ Vision Transformer
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        # For DropTrack
        self.temporal_pos_embed_z = nn.Parameter(torch.zeros(1, 1, embed_dim))
        self.temporal_pos_embed_x = nn.Parameter(torch.zeros(1, 1, embed_dim))
    ...
    def forward_features(self, z, x, mask_z=None, mask_x=None,
        ...
        z_event += self.temporal_pos_embed_z
        x_event += self.temporal_pos_embed_x
...
def _create_vision_transformer(pretrained=False, **kwargs):
    model = VisionTransformerSiam_DropMAE(**kwargs)
    return model


def vit_base_patch16_224_siam_dropmae(pretrained=False, **kwargs):
    """
