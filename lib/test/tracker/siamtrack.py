import math
from lib.models.vipt import build_siamtrack,build_siamtrack_384,build_siamtrack_lora
...
class SIAMTrack(BaseTracker):
    def __init__(self, params):
        super(SIAMTrack, self).__init__(params)
        network = build_siamtrack(params.cfg, training=False)
